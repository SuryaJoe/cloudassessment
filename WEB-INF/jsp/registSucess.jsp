                ...
                <div class="card-body LoginBg paddingLftRt30Rt0" style="border-right:1px solid #3c5a9a;">
                    <div >
                        ...
                        <div >                                
                            ...
                            <span class="LoginHead" ><font  style="text-align: center; padding-left: 200px;">Registration Successful!</font></span>
                            <br/>
                            <br>
                            <br>
                            <br>
                            ...
                            <b>Hello <font style="text-transform: capitalize;">${registrationForm.firstName} ${registrationForm.lastName},</font></b> <br/>Congratulations!  <br/>Your account has been successfully created.
                            You are just one step away to start assessment. <br/>
                            You will receive an email with activation link. 
                            Please click on the link in the mail to get your account activated.<br/>
                            In case, if you don't receive the activation link, please email us at info@cloudjournee.com
