        ...
        <header id="header" >
            <div class="headerbar">
                ...
                <div class="headerbar-right">
                    <span class="profile-info" style=" padding-right: 50px;">
                        <br/><br/> Hello <font style="text-transform: capitalize;">${firstname} ${lastname}</font>
                                    <small></small>
                                </span>
            </div>
        </header>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12 IconTopRt paddingLftRt0" >
                        ...
                        <ul>
                            ...
                            <li style="float:right;"><span class="downloads"></span> <a href="javascript:doit()">Download PDF</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 BgWhite paddingLftRt20">
                        ...
                        <div class="row">
                            ...
                            <div id="table_div" class="col-lg-8"  style="width: 350px; height:200px; left:35%; vertical-align: middle; ">
                        ...
                        <div class="table-responsive"  style="padding-left: 250px;padding-right:  250px;">
                            ...
                            <table  class="table table-striped table-hover" width="50%">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="question" items="${reportView.questions}" varStatus="counted">
                                        <c:forTokens var="token" items="${question.remarks}" delims=",">
                                            <tr class="gradeX AssReport">
